...
import cn.edu.jsu.yc.datebase.DataOperate;
...
public class PageController {//分页
	...
	{// 初始化代码块
		if(PageController.bigList==null) {
			PageController.bigList=DataOperate.getSelectAll("select * from inventory");// 调用查询数据库的方法，返回所有的行
		}
		//获取总页数
	...
	public static Vector<Vector> getBigList(){
		return bigList;
	}
	public static void setBigList(Vector<Vector> bigList){
		 PageController.bigList=bigList;
	}
